        ...
        <div className="card">
          ...
          <table className="data-table" style={{minWidth:900, tableLayout:"auto"}}>
            <thead><tr>
              ...
              <th style={{width:110, whiteSpace:"nowrap", position:"sticky", right:0, background:"#0a0a0a", zIndex:2, boxShadow:"-2px 0 6px rgba(0,0,0,.5)"}}></th>
            </tr></thead>
            <tbody>
              {(() => {
                const renderRow = (item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td style={{whiteSpace:"nowrap", position:"sticky", right:0, background:"#111111", zIndex:1, boxShadow:"-2px 0 6px rgba(0,0,0,.4)"}}>
