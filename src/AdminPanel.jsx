    ...
    <div>
      ...
      <div className="card mb-2">
        ...
        <div style={{ display:"flex", gap:10, alignItems:"center", flexWrap:"wrap", marginBottom:12 }}>
          ...
          <a
            href="https://login.xero.com/identity/connect/authorize?response_type=code&client_id=185BA8393B33423899C83D8B327A058B&redirect_uri=https://bnlndgjbcthxyodgstaa.supabase.co/functions/v1/xero-auth-callback&scope=openid+profile+email+accounting.transactions+accounting.contacts+offline_access&state=swindon-airsoft"
