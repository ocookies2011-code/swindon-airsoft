...
function AdminEventsBookings({ data, save, updateEvent, updateUser, showToast, cu }) {
  ...
  const blank = { title: "", date: "", time: "09:00", endTime: "17:00", location: "", description: "", walkOnSlots: 40, rentalSlots: 20, walkOnPrice: 25, rentalPrice: 35, banner: "", mapEmbed: "", extras: [], published: true, vipOnly: false, shopifyWalkOnVariantId: "", shopifyRentalVariantId: "" };
          ...
          <div className="modal-box wide" onClick={e => e.stopPropagation()}>
            ...
            <div style={{ background:"rgba(150,80,255,.06)", border:"1px solid rgba(150,80,255,.2)", borderRadius:4, padding:"12px 14px", marginBottom:16 }}>
              ...
              <div style={{ fontSize:11, color:"var(--muted)", lineHeight:1.6, marginBottom:10 }}>
                Set these to enable Shopify checkout for this event. Create a product in Shopify with two variants (Walk-On and Rental), then paste each variant's numeric ID here. Leave blank to use credits-only booking.
              </div>
              <div className="form-row">
                <div className="form-group" style={{ margin:0 }}>
              ...
              <div style={{ fontSize:10, color:"var(--muted)", marginTop:8, lineHeight:1.6 }}>
                To find a variant ID: Shopify Admin → Products → [product] → right-click a variant → inspect element → look for <code style={{ background:"rgba(255,255,255,.08)", padding:"1px 4px", borderRadius:2 }}>variant=XXXXXXXX</code> in the URL, or use the Shopify Admin API.
              </div>
            </div>
            <div className="form-group">
