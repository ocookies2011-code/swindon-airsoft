// pages/ReportCheatTab.jsx — cheat/hit-call reporting form
...
function ReportCheatTab({ cu, showToast }) {
          ...
          await sendEmail({
            ...
            htmlContent: `
              <div style="font-family:sans-serif;max-width:600px;background:#111;color:#ddd;padding:24px;border-radius:8px">
                <h2 style="color:#ef5350;font-family:'Oswald','Barlow Condensed',sans-serif;letter-spacing:.1em;text-transform:uppercase;margin-top:0">⚑ New Cheat Report</h2>
                <table style="width:100%;border-collapse:collapse;margin-bottom:20px">
                  <tr><td style="padding:8px;background:#111a0a;color:#888;font-size:12px;width:140px">REPORTED BY</td><td style="padding:8px;background:#0d0d0d;color:#fff">${cu.name}</td></tr>
                  <tr><td style="padding:8px;background:#111a0a;color:#888;font-size:12px">ACCUSED PLAYER</td><td style="padding:8px;background:#0d0d0d;color:#ef5350">${form.reportedName.trim() || "Not specified"}</td></tr>
                  <tr><td style="padding:8px;background:#111a0a;color:#888;font-size:12px">VIDEO EVIDENCE</td><td style="padding:8px;background:#0d0d0d"><a href="${form.videoUrl.trim()}" style="color:#c8ff00">${form.videoUrl.trim()}</a></td></tr>
                  <tr><td style="padding:8px;background:#111a0a;color:#888;font-size:12px">DESCRIPTION</td><td style="padding:8px;background:#0d0d0d;color:#ccc;white-space:pre-wrap">${form.description.trim()}</td></tr>
                </table>
  ...
  if (submitted) return (
    <div className="card" style={{ textAlign:"center", padding:"48px 24px" }}>
      ...
      <div style={{ fontFamily:"'Oswald','Barlow Condensed',sans-serif", fontWeight:900, fontSize:22, letterSpacing:".12em", color:"var(--accent)", marginBottom:10 }}>REPORT RECEIVED</div>
  ...
  return (
    <div className="card" style={{ maxWidth:640 }}>
      <div style={{ borderLeft:"3px solid #ef5350", paddingLeft:14, marginBottom:20 }}>
        <div style={{ fontFamily:"'Oswald','Barlow Condensed',sans-serif", fontWeight:900, fontSize:18, letterSpacing:".1em", color:"#ef5350" }}>REPORT A PLAYER FOR CHEATING</div>
    ...
    if (this.state.hasError) return (
      <div style={{ background:"#080a06", minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", padding:24 }}>
        <div style={{ maxWidth:480, width:"100%", background:"#0c1009", border:"1px solid #3a0a0a", padding:"32px 28px", position:"relative" }}>
          ...
          <div style={{ fontFamily:"'Oswald','Barlow Condensed',sans-serif", fontWeight:900, fontSize:26, letterSpacing:".1em", color:"#e8f0d8", marginBottom:8 }}>SOMETHING WENT WRONG</div>
          ...
          {this.state.error && (
            <div style={{ fontFamily:"'Share Tech Mono',monospace", fontSize:9, color:"#3a3a3a", background:"#080a06", border:"1px solid #111a0a", padding:"8px 10px", marginBottom:20, wordBreak:"break-all", lineHeight:1.6 }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
            <button
              ...
              style={{ background:"rgba(200,255,0,.08)", border:"1px solid #2a3a10", color:"#c8ff00", fontFamily:"'Oswald','Barlow Condensed',sans-serif", fontWeight:800, fontSize:12, letterSpacing:".2em", padding:"10px 24px", cursor:"pointer", width:"100%" }}>
              ↩ TRY AGAIN
            </button>
            <button
              onClick={() => window.location.reload()}
              style={{ background:"transparent", border:"1px solid #1a2808", color:"#3a5010", fontFamily:"'Oswald','Barlow Condensed',sans-serif", fontWeight:800, fontSize:12, letterSpacing:".2em", padding:"10px 24px", cursor:"pointer", width:"100%" }}>
              ↺ FULL RELOAD
            </button>
          </div>
        </div>
