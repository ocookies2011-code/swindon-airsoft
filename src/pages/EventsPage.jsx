...
function EventsPage({ data, cu, updateEvent, updateUser, showToast, setAuthModal, save, setPage, trackFunnel }) {
  ...
  // ── Event funnel tracking — top-level hook ────────────
  // Fires when visitor adds items to event basket while viewing an event.
  useEffect(() => {
    if (!trackFunnel || !detail) return;
  ...
  }, [bCart.walkOn, bCart.rental, JSON.stringify(bCart.extras), detail]); // eslint-disable-line
