...
function AdminPanel({ data, cu, save, updateUser, updateEvent, showToast, setPage, refresh }) {
  ...
  const totalBookings  = _activeEvts.flatMap(e => e.bookings).filter(b => !b.cancelledAt).reduce((sum, b) => sum + (b.qty || 1), 0);
  ...
  return (
    <div className="admin-shell">
      ...
      {section === "contact-inbox" && <AdminContactInbox showToast={showToast} cu={cu} />}
