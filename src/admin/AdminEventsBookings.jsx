...
function AdminEventsBookings({ data, save, updateEvent, updateUser, showToast, cu }) {
  ...
  const downloadTicket = (b, ev) => {
    ...
    const html = `<!DOCTYPE html><html><head><meta charset="utf-8">
      ...
      <body>
        ...
        <table>
          ...
          <tr><td style="padding:8px 14px;color:#555;font-weight:600;border-bottom:1px solid #eee">Total Paid</td><td style="padding:8px 14px;border-bottom:1px solid #eee;font-weight:700">£${Number(b.total||0).toFixed(2)}</td></tr>
        </table>
        <div class="qr">
          <div id="qr"></div>
    ...
    a.href = url;
    a.download = `ticket-${(b.userName||"player").replace(/\s+/g,"-").toLowerCase()}-${ev.date}.html`;
    a.click();
